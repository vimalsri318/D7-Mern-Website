...
<div>
    ...
    <div className="proimg">
      ...
      <div className="prom"> <NavLink to ='/dBats'><img className="promi"src={bbb} alt="This is my image." /></NavLink> <p className="protext">dBats</p></div> 
     <div className="prom"> <img className="promi"src={glove} alt="This is my image." /> <p className="protext">dGlove</p></div> 
     <div className="prom"> <img className="promi"src={baa} alt="This is my image." /> <p className="protext">dBalls</p></div> 
     <div className="prom"> <img className="promi"src={soo} alt="This is my image." /> <p className="protext">dShoes</p></div> 
     <div className="prom"> <img className="promi"src={kit} alt="This is my image." /> <p className="protext">dKitbags</p></div> 
     <div className="prom"> <img className="promi"src={he} alt="This is my image." /> <p className="protext">dHelmet</p></div> 
     <div className="prom"> <img className="promi"src={paa} alt="This is my image." /> <p className="protext">dPads</p></div> 
     <div className="prom"> <img className="promi"src={gla} alt="This is my image." /> <p className="protext">dGlasses</p></div> 
     <div className="prom"> <img className="promi"src={glove} alt="This is my image." /> <p className="protext">dGlove</p></div> 
     <div className="prom"> <img className="promi"src={glove} alt="This is my image." /> <p className="protext">dGlove</p></div> 
     <div className="prom"> <img className="promi"src={glove} alt="This is my image." /> <p className="protext">dGlove</p></div> 
